...
class BetMatchingServiceTest {
  ...
  @Mock private BetSettlementRocketProducer settlementProducer;

  @InjectMocks private BetMatchingServiceImpl betMatchingService;
  ...
  void shouldSkipBetWhenAlreadyClaimed() {
    ...
    when(betRepository.findById("bet-1")).thenReturn(Optional.of(claimedBet));
