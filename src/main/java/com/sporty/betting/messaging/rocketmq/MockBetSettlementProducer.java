...
/**
 * Fallback producer when RocketMQ is not available.
 * Logs the payload and directly invokes the settlement service
 * to simulate the full flow without RocketMQ infrastructure.
 */
@Slf4j
@Component
